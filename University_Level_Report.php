                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <div class="col-lg-12">
                            ...
                            <select class="form-control" onchange="SelectDocument(this.value)" id="Year" required>
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tr>
                            <td colspan="7">
                                <center>Specify The Faculty then Year</center>
                            </td>
                        </tr>
...
<script type="text/javascript">
    ...
    }function SelectDocument(v = '') {
        // alert(v);
        $.ajax({
            type: 'POST',
            url: 'Process?university_View=View&&v=' + v,
