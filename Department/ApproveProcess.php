...
if (isset($_SESSION['StaffId']) && $_SESSION['StaffType'] === 'Department') {
    ...
    if (isset($_REQUEST['Document'])) {
        $stmt = $conn->prepare("select DISTINCT * from documents as d, Proposal as p where d.Proposal_ID=p.ID and d.Rcc_Status='Not Approved' and d.Rcd_Status='Not Approved' and d.Status='Not Approved'  and p.Status='On Progress' and  p.Type=? and p.Faculty=? and p.Department=? order by date ASC");
        $Type = $_REQUEST["v"];
        ...
        if ($result->num_rows && $Type === "Thesis" and $Type = "Project" && $Type = "Other") {
        ...
        $stmt = $conn->prepare("select DISTINCT * from Proposal as p where   p.Status!='On Progress' and  p.Status!='Completed' and p.Department_level!='Rejected' and  p.Type=? and p.Faculty=? and p.Department=? order by p.Rcc_level ASC");
        $Type = $_REQUEST["v"];
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                data-target="<?php echo '#myModal' . $data['ID']; ?>">More
                        </button>
                                        ...
                                        <form action="Take_Agreement.php">
                                            <div class="form-group">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="email" name="Staff ID" class="form-control"
                                                           placeholder="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button type="submit" name="Submit" class="btn btn-primary"><a
                                                        href="Take_Agreement.php?Action=Agreed&&ProposalID=<?php echo $data['ID'] ?>">Agree</a>
                                            </button>
                                            <button type="submit" name="Submit" class="btn btn-primary"><a
                                                        href="Take_Agreement.php?Action=Disagreed&&ProposalID=<?php echo $data['ID'] ?>">Disagree</a>
                                            </button>
                                        </form>
                                    </div>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-info btn-small" data-toggle="modal"
                                data-target="<?php echo '#ToolTipModal' . $data['ID']; ?>">See
                        </button>
    ...
    else if (isset($_REQUEST['Proposals'])) {
        $Year = date('Y');
                                ...
                                <div class="modal-content">
                                    <form id="role-form" method="post" action="Merge_Proposal.php">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-12">
                                                    <center>
                                                        ...
                                                        //                                                    $Department_level = 'Not Approved';
                                                        $ID = $data['ID'];
                                                        $stmt = $conn->prepare("select * from proposal where Status!='Completed' and Status!='On Progress' and Merge_With='None'  and  Department=? and Type=? and ID!=? and Status!='On Progress' and Status!='Completed' and Status!='Merged' and date like '" . $Year . "%' order by date DESC");
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" name="Submit" class="btn btn-success">Merge</button>
