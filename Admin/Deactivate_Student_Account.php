...
{
    $_SESSION["Sidebar"] = "Deactivate_Student_Account";
                                ...
                                <div class="horizontal-form-elements">
                                    ...
                                    <div class="row">
                                        <table class="table table-sm table-bordered" id="tabledit">
                                            ...
                                            <tr>
                                                <th>
                                                    <center class="ID">ID</center>
                                                </th>
                                                <th>
                                                    <center class="First-Name">First Name</center>
                                                </th>
                                                <th>
                                                    <center class="Middle-Name">Middle Name</center>
                                                </th>
                                                <th>
                                                    <center class="Last-Name">Last Name</center>
                                                </th>
                                                <th>
                                                    <center class="Sex">Sex</center>
                                                </th>
                                                <th>
                                                    <center class="Status">Status</center>
                                                </th>
                                                <th>
                                                    <center class="Action">Action</center>
                                                </th>
                                            </tr>
                                            </thead>
                                            <tbody id="tbody">
...
<script>
    function SelectDocuments(v = '') {
        ...
        $.ajax({
            type: 'POST',
            url: 'Process.php?Approve_Student=Approve_Student&&Faculty=' + Faculty + '&&Department=' + Department + '&&v=' + v,
    ...
    function tableData() {
        ...
        $('#tabledit').Tabledit({
            ...
            columns: {
                identifier: [0, 'ID'],
                editable: [
                    [5, 'Status', '{"Reviewer":"Reviewer","None":"None"}']
                ]
            },
